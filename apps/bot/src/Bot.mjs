...
var GuildNotInGist =
  /* @__PURE__ */ Caml_exceptions.create('Bot.GuildNotInGist')
  ...
  if (isCommand) {
    ...
    console.log(
      '' +
        ...
        ' : ' +
        guildId +
        ': Successfully served the command ' +
        commandName +
        ' for ' +
        user.username +
        '',
  ...
  if (isButton) {
    ...
    console.log(
      '' +
        ...
        ' : ' +
        guildId +
        ': Successfully served button press "' +
        buttonCustomId +
        '" for ' +
        user.username +
        '',
...
async function onGuildDelete(guild) {
  ...
  var guilds
  try {
    guilds = await Gist$Utils.ReadGist.content(
  ...
  if (exit === 1) {
    ...
    if (match !== undefined) {
      ...
      var val
      try {
        val = await Gist$Utils.UpdateGist.removeEntry(
          guilds,
          guildId,
          gistConfig(undefined),
        )
      ...
      if (exit$1 === 2) {
        console.log(
          '' +
            ...
            ' : ' +
            guildId +
            ': Successfully removed guild data',
        )
        return
      }
    } else {
      console.error(
        '' +
          ...
          ' : ' +
          guildId +
          ': Could not find guild data to delete',
      )
      return
    }
  }
...
async function onGuildMemberAdd(guildMember) {
  ...
  if (exit === 1) {
    if (val._0.unique) {
        ...
        if (brightIdGuild !== undefined) {
          ...
          if (roleId !== undefined) {
            ...
            if (role == null) {
              ...
              var val$1
              try {
                val$1 = await guildMemberRoleManager.add(
                  role,
                  'User is already verified by BrightID',
                )
                exit$2 = 3
              } catch (raw_e$2) {
                var e$2 = Caml_js_exceptions.internalToOCamlException(raw_e$2)
              ...
              if (exit$2 === 3) {
                ...
                console.log(
                  '' +
                    ...
                    ' : ' +
                    guildId$1 +
                    ' verified the user with contextId: ' +
                    uuid +
                    '',
                )
              }
            ...
            console.error(
              '' + guildName + ' : ' + guildId$1 + ': ',
              'Guild does not have a saved roleId',
            )
          }
        } else {
          console.error(
            '' + guildName + ' : ' + guildId$1 + ': ',
            'Guild does not exist in Gist',
          )
        }
      }
    } else {
      console.error(
        '' + guildName + ' : ' + guildId + ': ',
        'User ' + guildMember.displayName + ' is not unique',
      )
    }
  }
}
...
async function onRoleUpdate(role) {
  ...
  var content
  try {
    content = await Gist$Utils.ReadGist.content(
      gistConfig(undefined),
      Decode$Shared.Decode_Gist.brightIdGuilds,
    )
    exit = 1
    ...
    if (brightIdGuild !== undefined) {
      ...
      if (roleId !== undefined) {
        ...
        var entry_premiumSponsorshipsUsed =
          brightIdGuild.premiumSponsorshipsUsed
        var entry_premiumExpirationTimestamp =
          brightIdGuild.premiumExpirationTimestamp
        var entry = {
          role: entry_role,
          name: entry_name,
        ...
        var val
        try {
          val = await Gist$Utils.UpdateGist.updateEntry(
            content,
            guildId,
            entry,
            gistConfig(undefined),
      ...
      if (roleId !== undefined) {
        ...
        switch (match$1) {
          case /* RoleAdded */ 0:
            ...
            var val
            try {
              val = await Services_VerificationInfo.getBrightIdVerification(
                newMember,
              )
              exit$1 = 2
            } catch (raw_e$1) {
            ...
            if (exit$1 === 2 && !val._0.unique) {
              ...
              if (role == null) {
                ...
                var val$1
                try {
                  val$1 = await guildMemberRoleManager.remove(
                    role,
                    'User is not verified by BrightID',
                  )
                  exit$2 = 3
                } catch (raw_e$2) {
                  var e$2 = Caml_js_exceptions.internalToOCamlException(raw_e$2)
                ...
                if (exit$2 === 3) {
                  ...
                  console.log(
                    '' +
                      ...
                      ' : ' +
                      guildId +
                      ' removed the role with contextId: ' +
                      uuid +
                      ' because the user is not verified but was manually assigned the role',
                  )
                }
              }
            }
          ...
          case /* RoleRemoved */ 1:
            ...
            var val$2
            try {
              val$2 = await Services_VerificationInfo.getBrightIdVerification(
                newMember,
              )
              exit$3 = 2
            } catch (raw_e$3) {
            ...
            if (exit$3 === 2 && val$2._0.unique) {
              ...
              if (role$1 == null) {
                ...
                var val$3
                try {
                  val$3 = await guildMemberRoleManager$1.add(
                    role$1,
                    'User is verified by BrightID',
                  )
                  exit$4 = 3
                } catch (raw_e$4) {
                ...
                if (exit$4 === 3) {
                  ...
                  console.log(
                    '' +
                      ...
                      ' : ' +
                      guildId +
                      ' added the role with contextId: ' +
                      uuid$1 +
                      ' because the user is verified but was not assigned the role',
                  )
                }
              }
            }
