...
const BRIGHTID_LINK_VERIFICATION_ENDPOINT = `https://app.brightid.org/link-verification/${NODE_URL}/${CONTEXT_ID}`
const BRIGHT_ID_APP_DEEPLINK = `brightid://link-verification/${NODE_URL}/${CONTEXT_ID}`
