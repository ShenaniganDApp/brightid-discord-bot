...
const CONTRACT_ADDRESS = '0x0aB346a16ceA1B1363b20430C414eAB7bC179324'
...
const CONTRACT_ABI = [
  ...
  {
    constant: true,
    inputs: [{ name: 'contextName', type: 'bytes32' }],
    name: 'totalContextBalance',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ name: '_finance', type: 'address' }],
    name: 'setFinance',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'financeAddr', type: 'address' }],
    name: 'FinanceSet',
    type: 'event',
  },
  {
...
module.exports = { CONTEXT_ID, CONTRACT_ABI, CONTRACT_ADDRESS }
